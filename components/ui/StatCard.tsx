...
export function StatCard({
  ...
  return (
    <div
      className={`rounded-2xl border-2 border-neutral-400 bg-white px-4 py-3.5 shadow-sm transition-all duration-150 hover:border-neutral-500 hover:shadow ${ring}`}
    >
