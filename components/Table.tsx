...
export function Table<T>({
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border-2 border-neutral-400 bg-white shadow-sm">
...
export function FilterBar({ children }: { children: ReactNode }) {
  return (
    <form
      className="mb-5 rounded-2xl border-2 border-neutral-400 bg-gradient-to-br from-neutral-50/80 to-white px-4 py-3 shadow-sm"
      role="search"
    >
